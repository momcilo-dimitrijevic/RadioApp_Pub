...
namespace Plugin.MediaManager
{
    public abstract class MediaServiceBase : Service, AudioManager.IOnAudioFocusChangeListener, IPlaybackManager
    {
        ...
        {
            base.OnCreate();
            //Find our audio and notification managers
...
//                                                             .SetLegacyStreamType(Stream.Music)
        ...
        public override IBinder OnBind(Intent intent)
        {
            ...
            Toast.MakeText(this, $"OnBind() method start from {this.GetType().Name}", ToastLength.Long).Show();
            return Binder;
        }
        ...
        public override bool OnUnbind(Intent intent)
        {
            ...
            Toast.MakeText(this, $"OnUnbind() method start from {this.GetType().Name}", ToastLength.Long).Show();
        ...
        public override void OnDestroy()
        {
            ...
            ReleaseWifiLock();
            SessionManager.Release();
            Toast.MakeText(this, $"OnDestroy() called in {this.GetType().Name}", ToastLength.Long).Show();
        }
